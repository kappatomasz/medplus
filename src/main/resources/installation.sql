...
create table meeting (id bigint generated by default as identity, date timestamp not null, description blob, selected boolean not null, title varchar(255) not null, primary key (id));
...
create table patients (id bigint not null, city varchar(100), flat varchar(10), house_no varchar(10), name varchar(100), pesel varchar(11), phone varchar(50), post_code varchar(6), second_name varchar(100), selected boolean not null, street varchar(200), surname varchar(100), meeting_id bigint, patient_log_id bigint, state_id integer, primary key (id));
